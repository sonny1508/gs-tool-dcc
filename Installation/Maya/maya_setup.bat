...
set "source_path_users2018=%GSTOOLS_ROOT%\Softwares\Maya\2018\scripts"

:: Construct the path to modules
set "source_path_modules=%GSTOOLS_ROOT%\Softwares\Maya\modules"

:: Define source and destination paths
set "destination_path_users2018=%USERPROFILE%\Documents\maya\2018\scripts"
...
xcopy "%source_path_modules%\*" "%destination_path_modules%"

xcopy "%source_path_users2018%\*" "%destination_path_users2018%"