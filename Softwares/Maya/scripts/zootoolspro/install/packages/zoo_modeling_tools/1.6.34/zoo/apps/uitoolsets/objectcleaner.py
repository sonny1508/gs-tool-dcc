...
class ObjectCleaner(toolsetwidget.ToolsetWidget):
    ...
    def deleteDisplayLayers(self):
        cleanup.deleteDisplayLayers()

    @toolsetwidget.ToolsetWidget.undoDecorator
    def deleteCameras(self):
        cleanup.deleteCameras()
    
    @toolsetwidget.ToolsetWidget.undoDecorator
    def deleteColorSets(self):
        cleanup.deleteColorSets()

    @toolsetwidget.ToolsetWidget.undoDecorator
    def deleteUnusedMaterials(self):
        cleanup.deleteUnusedMaterials()
    ...
    def uiConnections(self):
        ...
        for widget in self.widgets():
            ...
            # Modify Starts
            widget.deleteDisplayLayersBtn.clicked.connect(self.deleteDisplayLayers)
            widget.deleteCamerasBtn.clicked.connect(self.deleteCameras)
            widget.deleteColorSetsBtn.clicked.connect(self.deleteColorSets)
            widget.deleteUnusedMaterialsBtn.clicked.connect(self.deleteUnusedMaterials)
            # Modify Ends
...
class GuiWidgets(QtWidgets.QWidget):
    def __init__(self, parent=None, properties=None, uiMode=None, toolsetWidget=None):
        ...
        tooltip = "Delete all Display Layers on the selected polygon objects"
        self.deleteDisplayLayersBtn = elements.styledButton("Delete Display Layers",
                                                         icon="crossXFat",
                                                         toolTip=tooltip,
                                                         style=uic.BTN_LABEL_SML)
        # Delete Cameras ---------------------------------------
        tooltip = "Delete all Cameras in the scene"
        self.deleteCamerasBtn = elements.styledButton("Delete Cameras",
                                                         icon="crossXFat",
                                                         toolTip=tooltip,
                                                         style=uic.BTN_LABEL_SML)
        # Delete Color Set ---------------------------------------
        tooltip = "Delete all Color Set on the selected polygon objects"
        self.deleteColorSetsBtn = elements.styledButton("Delete Color Set",
                                                         icon="crossXFat",
                                                         toolTip=tooltip,
                                                         style=uic.BTN_LABEL_SML)
        # Delete Unused Materials ---------------------------------------
        tooltip = "Delete Unused Materials in the scene"
        self.deleteUnusedMaterialsBtn = elements.styledButton("Delete Unused Materials",
                                                         icon="crossXFat",
                                                         toolTip=tooltip,
                                                         style=uic.BTN_LABEL_SML)
        # Modify Ends
...
class GuiAdvanced(GuiWidgets):
    def __init__(self, parent=None, properties=None, uiMode=UI_MODE_ADVANCED, toolsetWidget=None):
        ...
        gridLayout.addWidget(self.deleteHistoryBtn, 9, 1)
        # Modify Starts
        gridLayout.addWidget(self.deleteDisplayLayersBtn, 10, 0)
        gridLayout.addWidget(self.deleteCamerasBtn, 10, 1)
        gridLayout.addWidget(self.deleteColorSetsBtn, 11, 0)
        gridLayout.addWidget(self.deleteUnusedMaterialsBtn, 11, 1)
        #M Modify Ends
        gridLayout.addWidget(self.deleteIntermediateBtn, 12, 0)
        gridLayout.addWidget(self.removeInstanceBtn, 12, 1)
        gridLayout.addWidget(self.checkSymmetryBtn, 13, 0)  # hidden
        gridLayout.addWidget(elements.LabelDivider(text="Face Components"), 14, 0, 1, 2)
        gridLayout.addWidget(self.selectTrisBtn, 15, 0)
        gridLayout.addWidget(self.selectNGonsBtn, 15, 1)
        gridLayout.addWidget(self.triangulateNGonsBtn, 16, 0)
        gridLayout.addWidget(elements.LabelDivider(text="OBJ Clean Import/Export"), 17, 0, 1, 2)
        gridLayout.addLayout(checkboxLayout, 18, 0, 1, 2)
        gridLayout.addWidget(self.keepParentStructureRadio, 19, 0, 1, 2)
        gridLayout.addWidget(self.cleanBtn, 20, 0, 1, 2)
