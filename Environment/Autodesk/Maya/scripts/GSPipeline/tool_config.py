...
TOOLS = [
    ...
    ("03 Files I/O", [
        {"name": "GS File Export",   "script": "03_Files_IO/gs_file_export.py",   "icon": "GS_File_Export_Icon.png"},
    ...
    ("05 Projects", [
        ...
        ("GSW", [
            {"name": "GSW Vehicle Tools",        "script": "05_Projects/GSW/gsw_vehicle_tools/launch.py"},
