...
def build_gui_renamer():
    ...
    selection_type_selected = cmds.radioButton(label='Selected', select=True,
                                               cc=lambda x: store_selection_type_persistent_settings())
    ...
    def store_selection_type_persistent_settings():
        ...
        set_persistent_settings_renamer('gt_renamer_selection_type',
                                        cmds.radioButton(cmds.radioCollection(selection_type_rc, q=True, select=True),
                                                         q=True, label=True))
    ...
    cmds.text('Rename:')
    rename_number_textfield = cmds.textField(placeholderText='new_name',
    ...
    start_number_textfield = cmds.textField(text=gt_renamer_settings.get('def_starting_number'),
                                            ...
                                            cc=lambda x: set_persistent_settings_renamer(
                                                'gt_renamer_def_starting_number',
                                                cmds.textField(start_number_textfield, q=True, text=True)))
    cmds.text('Padding:')
    ...
    transform_suffix_textfield = cmds.textField(text=gt_renamer_settings.get('transform_suffix'),
                                                ...
                                                cc=lambda x: set_persistent_settings_renamer(
                                                    'gt_renamer_transform_suffix',
                                                    cmds.textField(transform_suffix_textfield, q=True, text=True)))
    mesh_suffix_textfield = cmds.textField(text=gt_renamer_settings.get('mesh_suffix'),
                                           enterCommand=lambda x: start_renaming('add_suffix'),
                                           cc=lambda x: set_persistent_settings_renamer('gt_renamer_mesh_suffix',
                                                                                        cmds.textField(
                                                                                            mesh_suffix_textfield,
                                                                                            q=True, text=True)))
    nurbs_curve_suffix_textfield = cmds.textField(text=gt_renamer_settings.get('nurbs_crv_suffix'),
                                                  enterCommand=lambda x: start_renaming('add_suffix'),
                                                  cc=lambda x: set_persistent_settings_renamer(
                                                      'gt_renamer_nurbs_curve_suffix',
                                                      cmds.textField(nurbs_curve_suffix_textfield, q=True, text=True)))
    joint_suffix_textfield = cmds.textField(text=gt_renamer_settings.get('joint_suffix'),
                                            enterCommand=lambda x: start_renaming('add_suffix'),
                                            cc=lambda x: set_persistent_settings_renamer('gt_renamer_joint_suffix',
                                                                                         cmds.textField(
                                                                                             joint_suffix_textfield,
                                                                                             q=True, text=True)))
    locator_suffix_textfield = cmds.textField(text=gt_renamer_settings.get('locator_suffix'),
                                              enterCommand=lambda x: start_renaming('add_suffix'),
                                              cc=lambda x: set_persistent_settings_renamer('gt_renamer_locator_suffix',
                                                                                           cmds.textField(
                                                                                               locator_suffix_textfield,
                                                                                               q=True, text=True)))
    surface_suffix_textfield = cmds.textField(text=gt_renamer_settings.get('surface_suffix'),
                                              enterCommand=lambda x: start_renaming('add_suffix'),
                                              cc=lambda x: set_persistent_settings_renamer('gt_renamer_surface_suffix',
                                                                                           cmds.textField(
                                                                                               surface_suffix_textfield,
                                                                                               q=True, text=True)))
    ...
    left_prefix_textfield = cmds.textField(text=gt_renamer_settings.get('left_prefix'),
                                           enterCommand=lambda x: start_renaming('add_suffix'),
                                           cc=lambda x: set_persistent_settings_renamer('gt_renamer_left_prefix',
                                                                                        cmds.textField(
                                                                                            left_prefix_textfield,
                                                                                            q=True, text=True)))
    center_prefix_textfield = cmds.textField(text=gt_renamer_settings.get('center_prefix'),
                                             enterCommand=lambda x: start_renaming('add_suffix'),
                                             cc=lambda x: set_persistent_settings_renamer('gt_renamer_center_prefix',
                                                                                          cmds.textField(
                                                                                              center_prefix_textfield,
                                                                                              q=True, text=True)))
    right_prefix_textfield = cmds.textField(text=gt_renamer_settings.get('right_prefix'),
                                            enterCommand=lambda x: start_renaming('add_suffix'),
                                            cc=lambda x: set_persistent_settings_renamer('gt_renamer_right_prefix',
                                                                                         cmds.textField(
                                                                                             right_prefix_textfield,
                                                                                             q=True, text=True)))
    ...
    cmds.text('Search:')
    search_textfield = cmds.textField(placeholderText='search_text',
                                      enterCommand=lambda x: start_renaming('search_and_replace'))

    cmds.text('Replace:')
    replace_textfield = cmds.textField(placeholderText='replace_text',
                                       enterCommand=lambda x: start_renaming('search_and_replace'))
