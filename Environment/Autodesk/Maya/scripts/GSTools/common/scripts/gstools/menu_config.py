...
MENU = [
    ...
    },
    {
        ...
        "items": [
            ...
            {"id": "normal_tool", "label": "Simple Normal Transfer", "icon": "add_chris.png",
             "type": "mel_source", "source": "tools/normal_tools/GS_NormalTools_UI.mel",
             "command": "GS_NormalTools_UI;", "annotation": "Simple normal transfer tool (legacy MEL)."},
    ...
    },
    {
        ...
        "icon": "mesh.svg",
        "items": [
            {"id": "instance_utility", "label": "Instance Utility", "icon": "Modeling/instance_utility_icon.png",
             "type": "python", "module": "instance_utility", "function": "show",
             "annotation": "Detect and manage instances in a Maya scene."},
            ...
            {"id": "gs_property_transfer", "label": "Property Transfer", "icon": "CenterPivot.png",
             "type": "python", "module": "gs_property_transfer", "function": "show",
             "annotation": "Transfer properties from a picked source object to the selection (pivot)."},
            {"divider": True},
            ...
            # Installed by Exoside into Maya's own scripts dir, not shipped in
            # GSTools - "external" tells selfcheck not to look for it on our paths.
            {"id": "quad_remesher", "label": "QuadRemesher", "icon": "QuadRemesher.png",
             "type": "python", "module": "QuadRemesher", "function": "QuadRemesher",
             "external": True, "annotation": "Exoside QuadRemesher (vendor install)."},
            {"divider": True},
...
SHELF = [
    "instance_utility", "flatten_combine", "force_cleanup", "extract_tool", "gs_mirror",
    "gs_property_transfer", "remove_namespace",
    None,
    ...
    None,
    "switch_viewport_color", "auto_smoothing_groups",
    "outliner_sorter", "path_manager", "transfer_transforms",
    None,
    "gn_import", "gn_export", "fix_green_mesh",
    None,
