...
from ..operators.align_operator import UVPM3_OT_SelectSimilar, UVPM3_OT_AlignSimilar, UVPM3_OT_SplitOverlapping, UVPM3_OT_UndoIslandSplit, UVPM3_OT_GroupBySimilarity
from ..panels.align_panels import UVPM3_PT_SimilarityOptions, UVPM3_PT_AlignPriority, UVPM3_PT_SplitOverlapping
...
class UVPM3_Mode_Align(UVPM3_Mode_Main):
    ...
    def subpanels(self):
        ...
        return [
            ...
            UVPM3_PT_SplitOverlapping.bl_idname
        ]
    ...
    def setup_script_params(self):
        ...
        if self.op.split_offset_enabled():
    ...
    def get_iparam_serializers(self):
        ...
        if self.op.split_offset_enabled():
            serializer = VColorIParamSerializer(SplitOffsetIParamInfo())
            serializer.flags |= self.op.split_offset_iparam_flags()
    ...
    def operators(self):
        return [
            ...
            OperatorMetadata(UVPM3_OT_GroupBySimilarity.bl_idname)
        ]
