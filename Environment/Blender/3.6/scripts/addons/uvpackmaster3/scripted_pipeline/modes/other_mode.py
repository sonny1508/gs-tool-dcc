...
class UVPM3_Mode_Other(UVPM3_Mode_Main):
    ...
    def subpanels(self):
        from ..panels.other_panels import UVPM3_PT_OrientTo3dSpace, UVPM3_PT_OtherUtilities
        return [UVPM3_PT_OrientTo3dSpace.bl_idname, UVPM3_PT_OtherUtilities.bl_idname]
