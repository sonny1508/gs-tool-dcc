...
class UVPM3_PT_OrientTo3dSpace(UVPM3_PT_SubPanel):
    ...
    def draw_impl(self, context):
        ...
        col.separator()
        self.operator_with_help(UVPM3_OT_OrientTo3dSpace.bl_idname, col, help_url_suffix=self.ORIENT_TO_3D_SPACE_HELP_URL_SUFFIX)


class UVPM3_PT_OtherUtilities(UVPM3_PT_SubPanel):
