...
class Labels:
    ...
    STACK_GROUPS_ENABLE_DESC="Make the packer automatically stack islands belonging to the same group on top of each other before packing and then pack stacked islands together. Stacked islands will not be split during packing"
