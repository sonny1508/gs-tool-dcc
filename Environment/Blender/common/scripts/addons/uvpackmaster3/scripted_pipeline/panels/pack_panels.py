...
from ..panels.grouping_panels import GroupingSchemeDrawer
from ...panel import *
from ...labels import Labels
from ..operators.grouping_editor_operator import UVPM3_OT_EditGroupingSchemeInEditor
...
class UVPM3_PT_NumberedGroups(UVPM3_PT_SubPanel):
    ...
    def draw_impl(self, context):
        ...
        if groups_access.desc.use_g_scheme:
            g_scheme_drawer = GroupingSchemeDrawer(self.context, self.active_mode, groups_access.desc_id)
            ...
            if g_scheme_drawer.active_g_scheme is None:
                row.enabled = False
            else:
                op.g_scheme_idx = g_scheme_drawer.get_active_g_scheme_idx()
...
class UVPM3_PT_LockGroups(UVPM3_PT_NumberedGroups):
...
class UVPM3_PT_NonSquarePacking(UVPM3_PT_SubPanel):
    ...
    def draw_impl(self, context):
        ...
        self.operator_with_help(UVPM3_OT_AdjustIslandsToTexture.bl_idname, col, help_url_suffix=self.HELP_URL_SUFFIX)
